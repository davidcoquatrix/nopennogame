...
public class LocalStorageGameCatalogueService(ILocalStorageService localStorage) : IGameCatalogueService
{
    ...
    private readonly List<GameCatalogueItem> _baseGames = new()
    {
        ...
        new(Guid.Parse("77777777-7777-7777-7777-777777777777"), "🔟", "Phase 10", "Valide 10 combinaisons de cartes dans l'ordre, une par manche. Premier à valider la Phase 10 : victoire. Le score (cartes restantes) ne départage qu'à égalité de phase.", "Progression", "#F5A623", ScoreType.PhaseProgression, new GameRules(WinningPhase: Phase10Phases.TotalPhases, MaxPlayers: 6)),
